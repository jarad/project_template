...
fig_sum = list(target = paste0(".data/sum",sep,f$fig,sep,f$method,sep,f$i,".RData"),
...
tab_sum = list(target = paste0(".data/sum",sep,t$tab,sep,t$method,sep,t$i,".RData"),
...
f$files = with(f, paste0(fig,sep,method,sep,i,".RData"))
...
t$files = with(f, paste0(tab,sep,method,sep,i,".RData"))
